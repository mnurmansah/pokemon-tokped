    ...
    <Card className="mb-2 quick-history-card">
      <Accordion.Toggle as={Card.Header} eventKey={index} className="py-1 px-2">
        <Row>
          <Col xs={6}>
            ...
            <p className="mb-0 fs-8">{ day }, { time }</p>
          </Col>
          <Col xs={6} className="d-flex justify-content-end align-items-center">
            <img src={`/images/icons/${type}.svg`} alt={`${type}-icon`}></img>
      ...
      <Accordion.Collapse eventKey={index}>
        <Card.Body className="d-flex justify-content-end p-2">
          <Link to="/" className="mr-2 quick-history create"><img src="/images/icons/create.svg" alt="create-icon"></img></Link>
          <Link to="/" className="quick-history delete"><img src="/images/icons/close.svg" alt="delete-icon"></img></Link>
        </Card.Body>
      </Accordion.Collapse>
    </Card>
  )
